...
2. **Add a system environment variable**
    - `ENV_DIR_PATH` in your system. You can specify to this library where you what it to load the `.env` files from by adding an *ENV_DIR_PATH* in your system. Follow your spefic system intstructions on how to add an environment variable. 
